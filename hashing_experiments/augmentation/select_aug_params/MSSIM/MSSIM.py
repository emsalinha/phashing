...
def _SSIMForMultiScale(img1, img2, max_val=255, filter_size=11,
  ...
  Arguments:
    ...
    k1: Constant used to maintain stability in the SSIM calculation (0.01 in
      the original paper).
    k2: Constant used toscp maintain stability in the SSIM calculation (0.03 in
      the original paper).
...
def preprocess_img(img_path, hash_size=8, high_freq_factor=4):
...
if __name__ == '__main__':
  frame_paths = glob.glob(
    '/home/emsala/Documenten/Studie/These/phashing/program/create_dataset/augmentation/sample_frames/sampled_frames/*')
  # img1 = open_image(frame_paths, 0)
  # img2 = open_image(frame_paths, 1)
  # h = MultiScaleSSIM(img1, img2)
  # show_images(img1, img2, h)

  img1 = open_image(frame_paths[0], color = True)
  img2 = open_image(frame_paths[1], color = True)
  h = MultiScaleSSIM(img1, img2)
  show_images(img1, img2, h, color = True)
